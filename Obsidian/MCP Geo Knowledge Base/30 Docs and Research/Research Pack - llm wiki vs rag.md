---
title: "Research Pack - llm wiki vs rag"
...
- `research/llm_wiki_vs_rag/LLM Wiki, Enhanced RAG and the Right Knowledge Architecture for MCP-Geo.md`: `LLM Wiki, Enhanced RAG and the Right Knowledge Architecture for MCP-Geo` | `Executive summary` | `Terminology and source of truth` | `Prior-work map` | `Architecture comparison table` | `Enhanced RAG strategy section`
- `research/llm_wiki_vs_rag/README.md`: `Research Project: LLM Wiki versus RAG` | `Purpose` | `Background` | `Research Questions` | `Experimental Design` | `Metrics`
