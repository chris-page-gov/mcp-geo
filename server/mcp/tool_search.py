...
_PREFIX_CATEGORY: dict[str, ToolCategory] = {
    ...
    "landis_natmap": ToolCategory.FEATURES,
    "landis_nsi": ToolCategory.FEATURES,
    "landis_soilscapes": ToolCategory.FEATURES,
    "landis_derive": ToolCategory.FEATURES,
...
_PREFIX_KEYWORDS: dict[str, list[str]] = {
    ...
    "landis_natmap": ["landis", "natmap", "soil", "map-unit", "thematic", "texture", "carbon"],
