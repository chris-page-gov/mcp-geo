...
def handle_initialize(_params: Dict[str, Any]) -> Any:
    return {"server": "mcp-geo", "version": SERVER_VERSION, "capabilities": {"tools": True, "resources": True}}

def handle_list_tools(_params: Dict[str, Any]) -> Any:
    return {"tools": [
        {"name": t.name, "description": t.description, "version": t.version, "inputSchema": t.input_schema, "outputSchema": t.output_schema}
        for t in all_tools()
    ]}
