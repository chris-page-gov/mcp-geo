...
| --- | --- | --- | --- | --- | --- | --- |
| MCP specification | https://modelcontextprotocol.io/specification/2025-11-25 | Preview | maintainers | 2026-02-11 (spec + transport/lifecycle review) | Each release | Initialize negotiation now prefers `2025-11-25` and supports `2025-06-18`, `2025-03-26`, `2024-11-05`; HTTP validates `MCP-Protocol-Version` when provided. |
...
| MCP-Apps UI (`text/html;profile=mcp-app`) | docs/vendor/mcp/repos/ext-apps/specification/2026-01-26/apps.mdx | Stable | maintainers | 2026-02-11 (spec verification + negotiation hardening) | Each release | Finalized MCP Apps spec (`2026-01-26`); UI uses JSON-RPC `ui/initialize` and no skybridge fallback. |
| Agent Skills specification | https://agentskills.io/specification | Stable | maintainers | 2026-02-07 (spec + repo review) | Monthly | Vendored as git submodule at `docs/vendor/agentskills`. |
