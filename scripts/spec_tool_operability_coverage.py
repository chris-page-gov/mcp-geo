...
def _calc_operability(harness: dict[str, Any], probe: dict[str, Any]) -> dict[str, Any]:
    ...
    requirements = [
        ...
        },
        {
            ...
            "statement": "Functional live operability should be >= 95% of registered tools.",
            "measure": "(functional tools / registered tools) >= 95%",
            "actual": f"{len(functional_tools)}/{registered_tools}",
            "valuePercent": functional_percent,
            "status": "pass" if functional_percent >= 95.0 else "fail",
        },
        {
